...
CREATE INDEX ON reshare_derived.stat_rec (stre_supplier);

CREATE INDEX ON reshare_derived.stat_rec (stre_date_created);

CREATE INDEX ON reshare_derived.stat_rec (stre_req_id);

CREATE INDEX ON reshare_derived.stat_rec (stre_from_status);

CREATE INDEX ON reshare_derived.stat_rec (stre_to_status);
